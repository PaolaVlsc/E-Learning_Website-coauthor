...
<div class="mothership">
    <div class="container1">
        ...
        <div class="wrapper1">
            <aside>
                <div class="sidebar1">
                    <h2>ΚΡΙΤΗΡΙΑ ΔΙΑΙΡΕΤΟΤΗΤΑΣ</h2>
                    <br>
                    <hr>
                    <br>
                    <ul>
                        <!--<li class="active"><a href="#">Home</a></li>-->
                        <li class="theory active"><a href="#theory"><h4>Θεωρία</h4></a></li>
                        <br>
                        <li class="exercises"><a href="#exercises"><h4>Ασκήσεις</h4></a></li>
                        <br>
                        <li class="tests"><a href="#tests"><h4>Τεστ</h4></a></li>
                    </ul>
                </div>
            </aside>
